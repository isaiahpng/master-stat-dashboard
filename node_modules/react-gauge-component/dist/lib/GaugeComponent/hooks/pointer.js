...
import { PointerType, defaultPointerContext, getPointerLengthByType } from "../types/Pointer";
...
var drawSingleMultiPointer = function (gauge, pointerConfig, index, resize, minValue, maxValue, isGrafana) {
    ...
    var length = pointerConfig.length !== undefined
        ? pointerConfig.length
        : getPointerLengthByType(pointer.type);
    var typesWithPath = [PointerType.Needle, PointerType.Arrow];

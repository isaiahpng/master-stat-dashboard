...
import { defaultPointerRef, getPointerLengthByType } from "./types/Pointer";
...
var GaugeComponent = function (props) {
    ...
    var updateMergedProps = function () {
        ...
        if (((_c = props.pointer) === null || _c === void 0 ? void 0 : _c.length) === undefined) {
            var mergedPointer = mergedProps.current.pointer;
            if (mergedPointer === null || mergedPointer === void 0 ? void 0 : mergedPointer.type) {
                mergedPointer.length = getPointerLengthByType(mergedPointer.type);
            }
        }
